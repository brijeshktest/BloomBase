    ...
    <div className="min-h-screen" style={{ background: theme.background }}>
      ...
      {(store.instagramHandle || store.facebookHandle) && (
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="rounded-2xl p-6 shadow-lg" style={{ backgroundColor: theme.cardBg }}>
            <h3 className="text-lg font-bold mb-3" style={{ color: theme.textPrimary }}>
              Follow Us for Updates & Special Offers!
            </h3>
            <p className="text-sm mb-4" style={{ color: theme.textSecondary }}>
              Stay connected with us on social media to get the latest updates, new product launches, and exclusive offers.
            </p>
            <div className="flex flex-wrap gap-3">
              {store.instagramHandle && (
                ...
                >
                  ...
                  <span className="font-semibold">@{store.instagramHandle}</span>
                </a>
              )}
              {store.facebookHandle && (
                ...
                >
                  ...
                  <span className="font-semibold">{store.facebookHandle}</span>
                </a>
              )}
            </div>
          </div>
