...
export default function SharePlatformButton({
  ...
  const platformUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://selllocalonline.com';
  const shareText = 'Check out SellLocal Online - A platform for home-based retailers to list products and connect with buyers via WhatsApp. Start selling today!';
  ...
  const shareOptions = [
    ...
    },
    {
      ...
      color: '#1877F2',
      action: () => {
        const url = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(platformUrl)}&quote=${encodeURIComponent(shareText)}`;
          ...
          <>
            ...
            <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-zinc-200 z-50 py-2">
              <div className="px-4 py-2 border-b border-zinc-100">
                <p className="text-sm font-semibold text-zinc-900">Share SellLocal Online</p>
              </div>
              <div className="py-2">
